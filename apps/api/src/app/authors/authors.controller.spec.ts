...
describe('AuthorsController', () => {
  ...
  describe('getAuthors', () => {
    it('should return authors cache file', async () => {
      const cachePath = '/path/to/cache/authors.json';
    ...
    // Note: Error handling test skipped - same Promise.catch() issue as BooksController and SeriesController
  });
});
