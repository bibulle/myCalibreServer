...
## [0.13.0](https://github.com/bibulle/myCalibreServer/compare/my-calibre-server-v0.12.20...my-calibre-server-v0.13.0) (2026-07-05)
...
* automate CI/CD (Fixes [#100](https://github.com/bibulle/myCalibreServer/issues/100)) ([42bdfc8](https://github.com/bibulle/myCalibreServer/commit/42bdfc83a1d7371eb7cb360047137bd5ae72aad3))
...
* migrate calibre isbn field to identifiers table ([52b62c8](https://github.com/bibulle/myCalibreServer/commit/52b62c8dfca4c5f1cb4d89933d443461d96362ff))
...
* standardize error handling across backend API and frontend ([#133](https://github.com/bibulle/myCalibreServer/issues/133)) ([68e9926](https://github.com/bibulle/myCalibreServer/commit/68e99260e89558804e8f901bbce0f04bbd7cff4a))
...
* include series name in downloaded file title ([096bd2f](https://github.com/bibulle/myCalibreServer/commit/096bd2f75e530d01dfa0496421539fbaf0b35181))
...
* limit DockerHub push and DevOps config to master branch ([f498495](https://github.com/bibulle/myCalibreServer/commit/f498495fbf714929047da014379c31e03f31f88c))
...
* reload user from DB to prevent download count reset ([1b28a88](https://github.com/bibulle/myCalibreServer/commit/1b28a88a9e9ed4ce81fc73b494014d4667841919))
* remove warnings ([ef272fd](https://github.com/bibulle/myCalibreServer/commit/ef272fd96a74decd262fcf2c30273b8683420658))
* resolve all npm security vulnerabilities (75 → 0) ([e26ea6b](https://github.com/bibulle/myCalibreServer/commit/e26ea6bab3e41a0c1cbe2e0521a46da64cd69b49))
...
* supprimer les warnings Sass lors de la compilation du frontend ([ce03da9](https://github.com/bibulle/myCalibreServer/commit/ce03da91fd1725722275fb169aa6708604abfa0f))
...
* **api:** convert Promise constructor to async/await in mail.service.ts ([a3f23a3](https://github.com/bibulle/myCalibreServer/commit/a3f23a34217bfadb825fe22c1ee917da535bba10))
...
* **api:** convert Promise constructors to async/await in books.controller.ts ([6dfcd3f](https://github.com/bibulle/myCalibreServer/commit/6dfcd3f1f821475286df9b914e961000e8169177))
* **api:** convert Promise constructors to async/await in books.service.ts ([5d2e92b](https://github.com/bibulle/myCalibreServer/commit/5d2e92ba3f85e7e3bfa9a3f3a751dda23e86ed25))
...
* convert Promise constructors to async/await pattern ([b4c1b70](https://github.com/bibulle/myCalibreServer/commit/b4c1b70ac788efe3c6cc28cec322c6e23d7db4f2))
...
* upgrade to Angular 21, NestJS 11, Nx 22 and Node.js 24 LTS (v0.12.0) ([d5ccd13](https://github.com/bibulle/myCalibreServer/commit/d5ccd138a1d38577b37fccbff4a13e13401291a8))
...
* Add comprehensive tests for BooksController ([71e2c45](https://github.com/bibulle/myCalibreServer/commit/71e2c4580dc9f08d9a8348cc51ca51d4b03dfb6a))
...
* Add comprehensive unit tests for CalibreDb1Service with real SQLite test database ([126d321](https://github.com/bibulle/myCalibreServer/commit/126d321f96056a498a8a0208a8e0b5007f3b2d9e))
...
* add Cypress E2E testing for frontend ([2f3dfdc](https://github.com/bibulle/myCalibreServer/commit/2f3dfdc8fe05246b7e7bbbfdd952ef641439e67b))
...
* Add MongoDB test database infrastructure for MyCalibreDbService ([ecd4ead](https://github.com/bibulle/myCalibreServer/commit/ecd4ead55522d0c8e1d9593620dcefc51ed58ef8))
...
* Complete BooksController tests - all 25 tests passing ([01e8453](https://github.com/bibulle/myCalibreServer/commit/01e8453f3fa3b418a14dd5044729c0c481ec494d))
...
* **health:** add E2E and unit tests for health check endpoint ([c5195dc](https://github.com/bibulle/myCalibreServer/commit/c5195dc78ecd26618e1c7afea07375927a92d3de))
...
### [0.12.20](https://github.com/bibulle/myCalibreServer/compare/v0.12.19...v0.12.20) (2026-07-05)
...
### [0.12.16](https://github.com/bibulle/myCalibreServer/compare/v0.12.15...v0.12.16) (2026-07-05)

### [0.12.15](https://github.com/bibulle/myCalibreServer/compare/v0.12.14...v0.12.15) (2026-07-05)

### [0.12.14](https://github.com/bibulle/myCalibreServer/compare/v0.12.13...v0.12.14) (2026-07-04)
